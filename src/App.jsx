...
const items = [
  ...
  },
  {
    ...
    desc: "Juicy chicken patty with lettuce, tomato, cheese, and a special sauce in a toasted bun.",
    price: 149,
    type: "non-veg",
    ratings: 4.6
  }
  ...
  return(
    <>
      <div className="flex gap-2 mt-12 justify-center">
          {
            items.map(item=><Card img={item.img} ratings={item.ratings} title={item.foodname} desc={item.desc} type={item.type} price={item.price} />)
          }
      </div>
    </>
  )
